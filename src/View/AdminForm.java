...
public class AdminForm extends javax.swing.JFrame {
    ...
    public AdminForm() {
        ...
        bookCategory = bookService.getCategoryFromDB();
        cboTheLoai.setModel(new DefaultComboBoxModel(bookCategory.toArray()));
        fillDataToTable();
    }
    ...
    Book getGuiDataControl() {
        return new Book(txtTenSach.getText(), txtTacgia.getText(), ((BookCategory) cboTheLoai.getSelectedItem()).getCode());
    }
    /**
    ...
    private void initComponents() {
        ...
        rdoTang.setText("Tang");

        rdoGiam.setText("Giam");
    ...
    private void tblListBookMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListBookMouseClicked
        ...
        cboTheLoai.setSelectedItem(findCategoryBoxByName(
                tblListBook.getModel().getValueAt(rowIndex, 3).toString()));
    }//GEN-LAST:event_tblListBookMouseClicked
    
    private BookCategory findCategoryBoxByName(String categoryName) {
        for (int i = 0; i < bookCategory.size(); i++) {
            BookCategory category = cboTheLoai.getItemAt(i);
    ...
    private void btnSortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSortActionPerformed
        // 1= ASC, 0 = DESC
        if (rdoTang.isSelected()) {
            listBook = bookService.sortFromDB(1);
        } else if (rdoGiam.isSelected()) {
            listBook = bookService.sortFromDB(0);
        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        listBook = bookService.searchFromDB(txtTimkiem.getText());
        fillDataToTable();
    ...
    private int getBookId() {
        int rowIndex = tblListBook.getSelectedRow();
        if (rowIndex >= 0) {
            int id = Integer.valueOf(tblListBook.getModel().getValueAt(rowIndex, 0).toString());
            return id;
        } else {
            return 0;
        }
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        // TODO add your handling code here:
        Book bookUpdated = getGuiDataControl();
        bookUpdated.setId(getBookId());
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        bookUpdated.setId(getBookId());
        JOptionPane.showMessageDialog(this, 
                bookService.deleteBook(bookUpdated));
        // Choc vao DB de lay lai du lieu
        listBook = bookService.getListBookFromDB();
        fillDataToTable();
    ...
    private javax.swing.JComboBox<BookCategory> cboTheLoai;
